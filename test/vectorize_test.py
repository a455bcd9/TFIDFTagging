...
word_vectorizer = TfidfVectorizer(max_df=0.6, strip_accents='ascii', stop_words=stopwordsfrench, 
    token_pattern=u'[a-zA-Z]{3,}')
bigram_vectorizer = TfidfVectorizer(ngram_range=(1, 2), max_df=0.6, strip_accents='ascii', stop_words=stopwordsfrench, 
    token_pattern=u'[a-zA-Z]{3,}')
trigram_vectorizer = TfidfVectorizer(ngram_range=(1, 3), max_df=0.6, strip_accents='ascii', stop_words=stopwordsfrench, 
    token_pattern=u'[a-zA-Z]{3,}')
